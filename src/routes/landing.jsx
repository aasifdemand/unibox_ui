...
const Pill = ({ children, className = '' }) => (
  <span
    className={`inline-flex items-center gap-1.5 text-xs font-semibold tracking-widest uppercase px-3 py-1 rounded-full border ${className}`}
  >
    {children}
  </span>
);
...
const GlassCard = ({ children, className = '', hover = true }) => (
  <div
    className={`relative bg-white/70  border border-white/80 shadow-[0_4px_24px_-4px_rgba(99,102,241,0.12)] ${hover ? 'hover:shadow-[0_8px_40px_-4px_rgba(99,102,241,0.22)] hover:-translate-y-1 transition-all duration-300' : ''} ${className}`}
  >
    {children}
  </div>
);
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              className="md:hidden bg-white/95  border-t border-slate-100 shadow-sm px-6 py-5 space-y-3"
            >
              {['Features', 'Solutions', 'Pricing'].map((item) => (
                <a
                  key={item}
              ...
              <div className="border-t border-slate-100 pt-4 space-y-3">
                <Link to="/auth/login" className="block py-2 text-slate-700 font-medium">
                  Log in
                </Link>
                <Link
                  to="/auth/signup"
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-16 items-center">
            <motion.div style={{ y: heroY, opacity: heroOpacity }}>
              ...
              >
                Connect Gmail, Outlook, and custom SMTP servers in one powerful platform. Automate
                sequences, rotate mailboxes, and scale without limits.
              </motion.p>
                ...
                <div className="bg-white rounded-b-2xl p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div
                        key={s.label}
                        className={`bg-${s.color}-50/60 border border-${s.color}-100 rounded-md p-3`}
                      >
                        ...
                        <div className={`text-xs text-${s.color}-600 font-semibold mt-0.5`}>
                          {s.delta}
                        </div>
                      </div>
                    ))}
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            {['Stripe', 'Notion', 'Linear', 'Vercel', 'Loom', 'Figma'].map((name) => (
              <div
                key={name}
                className="text-slate-300 text-xl font-black tracking-tight hover:text-slate-500 transition-colors cursor-default select-none"
                style={{ fontFamily: 'Outfit, sans-serif' }}
              >
                {name}
              </div>
          ...
          <div className="max-w-2xl mb-16">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}>
              ...
              >
                Connect every
                <br />
                <GradientText>email provider</GradientText>
              </h2>
              <p className="text-lg text-slate-500">
                Seamlessly integrate with all major email platforms through a single, unified
                interface.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {mailboxFeatures.map((f, i) => (
              ...
              >
                ...
                <div
                  className={`w-12 h-12 rounded-lg ${f.bg} ${f.text} flex items-center justify-center mb-5 border ${f.border}`}
                >
                  {f.icon}
                </div>
                <h3
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">
                  Yahoo, iCloud, Zoho, ProtonMail and more
                </div>
              </div>
            </div>
            <div className="flex gap-2">
      ...
      <section className="py-28 px-6 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}>
              ...
              >
                ...
                <br />
                for <GradientText>scale</GradientText>
              </h2>
              <p className="text-lg text-slate-500">
                Everything you need to create, manage, and optimise your email outreach campaigns.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {campaignFeatures.map((f, i) => (
              ...
              >
                ...
                <h3
                  className="text-base font-black text-slate-900 mb-2 tracking-tight"
                  style={{ fontFamily: 'Outfit, sans-serif' }}
                >
                  {f.title}
                </h3>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            className="mt-12 bg-slate-50 border border-slate-200 rounded-lg overflow-hidden"
          >
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-7 border-r border-slate-200 space-y-1">
                {['Create Sequence', 'Add Mailboxes', 'Set Conditions', 'Launch & Track'].map(
                  (step, i) => (
                    <div
                      key={step}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}>
              ...
              <h2
                className="text-4xl md:text-5xl font-black tracking-tighter mb-5"
                style={{ fontFamily: 'Outfit, sans-serif' }}
              >
          ...
          <div className="grid md:grid-cols-3 gap-6 items-center">
            {plans.map((plan, i) => (
              ...
              >
                ...
                <button
                  onClick={() =>
                    plan.name === 'Enterprise' ? navigate('/contact') : navigate('/auth/signup')
                  }
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm leading-relaxed mb-5">
                Unified email outreach for modern sales teams.
              </p>
