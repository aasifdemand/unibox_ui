...
const SmartInsights = ({ metrics, overview }) => {
    ...
    const getStatusStyles = (status) => {
        switch (status) {
            case "success": return "bg-emerald-50 text-emerald-700 border-emerald-100 ring-emerald-500/20";
            case "warning": return "bg-amber-50 text-amber-700 border-amber-100 ring-amber-500/20";
            case "danger": return "bg-rose-50 text-rose-700 border-rose-100 ring-rose-500/20";
                    ...
                    >
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-xl bg-white/80 backdrop-blur-sm shadow-sm border border-transparent`}>
                                    {insight.icon}
                                </div>
                                <div>
                                    <h4 className="text-[12px] font-black uppercase tracking-tight opacity-80">{insight.title}</h4>
