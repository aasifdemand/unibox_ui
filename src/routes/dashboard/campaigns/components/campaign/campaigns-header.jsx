    ...
    <div className="w-full animate-in fade-in slide-in-from-top-4 duration-700 pb-4 md:pb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {/* Search */}
            <div className="relative group flex items-center bg-white border border-slate-200 rounded-md px-4 h-11 w-full transition-all focus-within:ring-2 focus-within:ring-purple-500/10 focus-within:border-purple-500/40 focus-within:bg-white shadow-sm">
          ...
          <button
            ...
            className="w-11 h-11 flex justify-center items-center rounded-md border border-slate-200 bg-white text-slate-500 hover:text-purple-600 hover:border-purple-200 transition-all active:scale-95 shadow-sm"
