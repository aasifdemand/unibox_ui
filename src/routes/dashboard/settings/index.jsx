    ...
    <div className="w-full p-4  animate-in fade-in duration-500">
      <div >
        ...
        <div className="mt-16 pt-10 border-t border-slate-100 flex flex-col items-center text-center">
          ...
          <h4 className="text-base font-bold text-slate-800 mb-1.5 font-display">
            {t('settings.help.title', 'Need additional help?')}
          </h4>
          <p className="text-xs font-semibold text-slate-400 mb-8 font-sans">
            {t('settings.help.desc', 'Technical assistance with custom infrastructure or billing.')}
          </p>
          <button className="h-11 px-10 bg-white text-purple-600 border border-purple-200 hover:border-purple-600 rounded-lg text-xs font-bold transition-all shadow-sm hover:shadow-purple-500/5 active:scale-95 font-display">
