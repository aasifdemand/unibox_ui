    ...
    <div className="w-full p-4  animate-in fade-in duration-500">
      <div className="max-w-7xl">
        ...
        <div className="mt-16 pt-10 border-t border-slate-100 flex flex-col items-center text-center">
          ...
          <button className="h-11 px-10 bg-white text-orange-600 border border-orange-200 hover:border-orange-600 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all shadow-sm hover:shadow-orange-500/5 active:scale-95 font-display">
