  ...
  return (
    <div className="h-full flex flex-col bg-slate-50/50">
      ...
      <div className="bg-white px-6 py-4 border-b border-slate-200/60 shadow-xs">
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 w-full mx-auto">
          <div className="flex-1 relative group">
            <Search className="absolute ltr:left-4 ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-blue-500 transition-all duration-300" />
            <input
              type="text"
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 md:pb-0">
            <div className="relative shrink-0">
              <select
                ...
                className="appearance-none ltr:pl-4 ltr:pr-4 rtl:pl-4 ltr:pr-10 rtl:pl-10 py-3 bg-slate-50/50 border border-slate-200/80 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-700 shadow-xs focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500/50 transition-all outline-none cursor-pointer"
              >
      ...
      <div className="flex-1 flex min-h-0 w-full mx-auto">
        ...
        {folders.length > 0 && (
          <div className="w-72 bg-white/40 backdrop-blur-sm ltr:border-r rtl:border-l border-slate-200/60 overflow-y-auto shrink-0 hidden lg:block">
            <FolderTree
              folders={folders}
                  ...
                  <div className="absolute inset-0 z-50 flex items-center justify-center bg-slate-50/40 backdrop-blur-[2px] transition-all duration-500">
                    <div className="flex flex-col items-center gap-4 p-8 bg-white/80 rounded-[2.5rem] shadow-2xl border border-white ring-1 ring-slate-200/50 animate-in zoom-in-95 duration-300">
                      <div className="relative">
                        ...
                        <div className="absolute top-0 ltr:left-0 ltr:right-0 rtl:left-0 w-12 h-12 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
                      </div>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] animate-pulse">
                        {t('mailboxes.updating_feed')}
                      </p>
                    </div>
                  </div>
                )}
