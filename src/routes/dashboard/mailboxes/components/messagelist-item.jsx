        ...
        <div className="flex items-start justify-between mb-4">
          <div className="relative group/check">
            ...
            <input
              ...
              className="absolute -right-1.5 -top-1.5 w-4 h-4 text-blue-600 rounded-md border-slate-200 focus:ring-blue-500 shadow-sm transition-opacity opacity-0 group-hover/check:opacity-100"
            />
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-slate-500 font-medium line-clamp-1 ml-14 opacity-80 leading-relaxed">
          {getPreview(message)}
        </p>
