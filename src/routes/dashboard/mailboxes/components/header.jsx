            ...
            <div className="flex items-center gap-3">
              ...
              {view === 'messages' && selectedMailbox && (
                <div className="hidden sm:flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-400 bg-slate-50 px-2.5 py-1 rounded-full border border-slate-200/60 shadow-xs">
              ...
              {view === 'messages' && selectedMailbox && (
                <div className="flex items-center flex-wrap gap-2">
                  <div className="flex items-center gap-1.5">
                      <span className="px-3 py-1 bg-purple-50/50 text-purple-600 rounded-lg text-xs font-bold border border-purple-100 shadow-xs">
                        {selectedFolder.name}
                      </span>
                      <span className="px-3 py-1 bg-purple-50/50 text-purple-600 rounded-lg text-xs font-bold border border-purple-100 shadow-xs animate-pulse">
              ...
              {selectedSenderIds?.length > 0 ? (
                <div className="flex items-center gap-1.5 bg-purple-600 px-3 py-1.5 rounded-md shadow-sm shadow-purple-500/20 animate-in zoom-in duration-300">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all text-xs font-bold"
