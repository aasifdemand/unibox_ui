...
export const isFolderType = (folder, type) => {
  ...
  switch (t) {
    ...
    case 'DRAFTS':
      return (
        isMatch(id, ['DRAFT', 'DRAFTS', 'DRAFTMESSAGES', 'DRAFT_MESSAGES']) ||
    ...
    case 'SPAM':
      return (
        isMatch(id, ['SPAM', 'JUNK', 'JUNKEMAIL', 'JUNK_EMAIL', 'JUNKMAIL', 'SPAM_MESSAGES']) ||
        isMatch(name, ['SPAM', 'JUNK', 'JUNK EMAIL', 'JUNK_EMAIL', 'JUNKMAIL', 'SPAM MESSAGES'])
      );
    case 'ARCHIVE':
      return (
        isMatch(id, ['ARCHIVE', 'ARCHIVED', 'ARCHIVEMESSAGES']) ||
        isMatch(name, ['ARCHIVE', 'ARCHIVED', 'ARCHIVE MESSAGES'])
      );
    case 'STARRED':
      return (
        isMatch(id, ['STARRED', 'FLAGGED', 'STAR']) ||
        isMatch(name, ['STARRED', 'FLAGGED', 'STAR', 'STARRED MESSAGES'])
      );
    case 'IMPORTANT':
      return (
        isMatch(id, ['IMPORTANT', 'IMPORTANT MESSAGES', 'IMPORTANT_MESSAGES']) ||
    ...
    case 'CATEGORY_PROMOTIONS':
      return (
        isMatch(id, ['CATEGORY_PROMOTIONS']) || isMatch(name, ['CATEGORY_PROMOTIONS', 'PROMOTIONS'])
      );
    ...
    case 'CONVERSATION_HISTORY':
      return (
        isMatch(id, ['CONVERSATION HISTORY', 'CONVERSATION_HISTORY']) ||
        isMatch(name, ['CONVERSATION HISTORY', 'CONVERSATION_HISTORY'])
      );
    case 'RSS_FEEDS':
