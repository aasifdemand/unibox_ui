  ...
  return (
    <div className="premium-card bg-white border-none p-20 text-center flex flex-col items-center justify-center relative overflow-hidden shadow-2xl shadow-blue-500/5">
      ...
      <div className="relative mb-10">
        <div className="w-24 h-24 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-4xl flex items-center justify-center rotate-3 group hover:rotate-6 transition-transform duration-500 shadow-2xl shadow-indigo-500/20">
