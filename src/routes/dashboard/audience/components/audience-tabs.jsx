      ...
      <div className="bg-white/80 border-b border-slate-200/50 px-8">
        <nav className="flex items-center gap-10">
          <button
            ...
            className={`relative py-6 font-extrabold text-[10px] uppercase tracking-[0.2em] transition-all duration-300 ${
              activeTab === 'contacts' ? 'text-blue-600' : 'text-slate-400 hover:text-slate-800'
            }`}
          >
          ...
          <button
            ...
            className={`relative py-6 font-extrabold text-[10px] uppercase tracking-[0.2em] transition-all duration-300 ${
              activeTab === 'senders' ? 'text-blue-600' : 'text-slate-400 hover:text-slate-800'
            }`}
          >
            <div className="flex items-center gap-2">
            ...
            <AnimatePresence mode="wait">
              {isLoadingSenders ? (
                ...
                >
                  ...
                  <p className="text-sm font-medium text-slate-400 max-w-xs mb-8">
                    No email senders found. Add a sender to start sending campaigns.
                  </p>
                  <button
                    onClick={() => setShowSenderModal(true)}
                    className="btn-primary py-3 px-8 flex items-center gap-3"
                    ...
                    >
                      <div className="flex items-start justify-between mb-8">
                        <div className="flex items-center gap-5">
                          <div
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-500 ${
                              sender.type === 'gmail'
