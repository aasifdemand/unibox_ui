                    ...
                    <div className="flex items-start justify-between mb-8">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-4 py-2 bg-slate-800 text-white rounded-xl text-[10px] font-extrabold uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95 shadow-lg shadow-slate-900/10"
                        >
                          Test Connection
                        </button>
                      </div>
