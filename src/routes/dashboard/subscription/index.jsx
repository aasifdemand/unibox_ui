        ...
        <div className="p-8 pb-32 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-1000">
                ...
                {plans.map((plan, index) => (
                    ...
                    >
                        ...
                        <div className="p-10 pb-0">
                            <div className="w-16 h-16 rounded-[1.5rem] bg-white border border-slate-100 flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 transition-transform duration-500">
                                {plan.icon}
                            </div>
                            ...
                            <p className="text-[11px] font-bold text-slate-400 mb-10 italic uppercase tracking-widest">{plan.billing}</p>
                            ...
                            <ul className="space-y-5">
                                {plan.features.map((feature, idx) => (
                                    <li key={idx} className="flex items-start gap-4">
                                        <div className={`mt-0.5 rounded-full p-0.5 ${plan.popular ? "bg-blue-100" : "bg-emerald-100"}`}>
                                            <CheckCircle2
                                                className={`w-3.5 h-3.5 shrink-0 ${plan.popular ? "text-blue-600" : "text-emerald-600"
                                                    }`}
                                            />
                                        </div>
                                        <span className="text-sm font-bold text-slate-600/80 leading-snug">{feature}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
            ...
            <div className="mt-32 pt-16 border-t border-slate-200/60 text-center relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-8">
                    <div className="w-16 h-16 rounded-[2rem] bg-slate-50 border border-slate-100 flex items-center justify-center shadow-sm">
                ...
                <p className="text-sm font-bold text-slate-500/70 max-w-lg mx-auto leading-relaxed">
                    ...
                    <br />
                    Reach out to our specialists at <span className="text-blue-600 font-extrabold cursor-pointer hover:text-black transition-all">billing@unibox.co</span>
                </p>
            </div>
        </div>
    );
