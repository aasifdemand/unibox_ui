...
files.forEach((file) => {
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\bborder-l(-[a-zA-Z0-9\[\]\-.]+)?\b(?!eft)/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\bborder-r(-[a-zA-Z0-9\[\]\-.]+)?\b(?!ight)/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  // === ROUNDED CORNERS ===
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-l(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-r(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-tl(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-tr(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-bl(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\brounded-br(-[a-zA-Z0-9\[\]\-.]+)?\b/g,
    (match, suffix) => {
      const suf = suffix || '';
  ...
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\b-translate-x-full\b/g,
    'ltr:-translate-x-full rtl:translate-x-full',
  );
  content = content.replace(
    /(?<![lr]tr:)(?<!\w)\btranslate-x-full\b/g,
    'ltr:translate-x-full rtl:-translate-x-full',
  );
