          ...
          <>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 bg-purple-50 rounded-lg flex items-center justify-center border border-purple-100">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <div className="relative group">
                    <Search className="absolute ltr:left-4 ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-purple-500 transition-colors" />
                    <input
                      type="text"
                      placeholder={t('modals.details.filters.search_placeholder')}
                      value={searchTerm}
                      onChange={handleSearchChange}
                      className="w-full ltr:pl-12   ltr:pr-4 rtl:pl-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-bold placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-purple-500/5 focus:border-purple-500 outline-none transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none ltr:pl-10 ltr:pr-10 rtl:pl-10 ltr:pr-10 rtl:pl-10 py-3 bg-white border border-slate-200 rounded-lg text-sm font-bold text-slate-700 focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500 transition-all outline-none"
                    >
                  ...
                  <Button
                    ...
                    variant="primary"
                    className="px-6 py-3 rounded-lg text-[10px] font-extrabold uppercase tracking-widest shadow-sm shadow-purple-600/20 hover:shadow-purple-600/40 hover:-translate-y-0.5 transition-all active:scale-95 flex items-center gap-2"
                  >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center group-hover:bg-purple-100 transition-colors">
                              <Mail className="w-4 h-4 text-slate-500 group-hover:text-purple-600" />
                            </div>
              ...
              <div className="flex items-center justify-between pt-8 mt-6 border-t-2 border-slate-100">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-10 h-10 rounded-md bg-white border-2 border-slate-100 flex items-center justify-center text-slate-400 hover:border-purple-500 hover:text-purple-600 transition-all disabled:opacity-50 disabled:hover:border-slate-100 disabled:hover:text-slate-400"
                  >
            ...
            <div className="mt-6 pt-4 border-t-2 border-slate-100 flex items-center justify-between">
              ...
              <Button
                onClick={handleExport}
                variant="primary"
                className="px-8 py-3 rounded-lg text-[10px] font-extrabold uppercase tracking-widest shadow-sm shadow-purple-600/20 hover:shadow-purple-600/40 hover:-translate-y-1 transition-all active:scale-95 flex items-center gap-3"
              >
                <Download className="w-4 h-4" />
