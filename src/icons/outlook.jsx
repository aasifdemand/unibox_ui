  ...
  <svg {...props} viewBox="60 90.4 570.02 539.67">
    <defs>
      ...
      >
        ...
        <stop offset=".4" style={{ stopColor: '#1976d2', stopOpacity: '1' }} />
        <stop offset="1" style={{ stopColor: '#42a5f5', stopOpacity: '1' }} />
      </linearGradient>
      <linearGradient
      ...
      >
        ...
        <stop offset=".501" style={{ stopColor: '#90caf9', stopOpacity: '1' }} />
        <stop offset="1" style={{ stopColor: '#1565c0', stopOpacity: '1' }} />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".237" style={{ stopColor: '#1976d2', stopOpacity: '0' }} />
        <stop offset=".792" style={{ stopColor: '#42a5f5', stopOpacity: '.2' }} />
      </linearGradient>
      <linearGradient
      ...
      >
        <stop offset="0" style={{ stopColor: '#64b5f6', stopOpacity: '1' }} />
        <stop offset=".492" style={{ stopColor: '#90caf9', stopOpacity: '1' }} />
        <stop offset="1" style={{ stopColor: '#1565c0', stopOpacity: '1' }} />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" style={{ stopColor: '#1976d2', stopOpacity: '0' }} />
        <stop offset=".67" style={{ stopColor: '#42a5f5', stopOpacity: '.2' }} />
      </linearGradient>
      <linearGradient
      ...
      >
        <stop offset="0" style={{ stopColor: '#64b5f6', stopOpacity: '1' }} />
        <stop offset=".196" style={{ stopColor: '#90caf9', stopOpacity: '1' }} />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".206" style={{ stopColor: '#1565c0', stopOpacity: '1' }} />
        <stop offset=".535" style={{ stopColor: '#1976d2', stopOpacity: '0' }} />
      </linearGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".568" style={{ stopColor: '#42a5f5', stopOpacity: '0' }} />
        <stop offset=".992" style={{ stopColor: '#64b5f6', stopOpacity: '1' }} />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".259" style={{ stopColor: '#90caf9', stopOpacity: '.4' }} />
        <stop offset=".908" style={{ stopColor: '#1565c0', stopOpacity: '0' }} />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".732" style={{ stopColor: '#1976d2', stopOpacity: '0' }} />
        <stop offset="1" style={{ stopColor: '#1976d2', stopOpacity: '.501961' }} />
      </radialGradient>
      <radialGradient
      ...
      >
        ...
        <stop offset=".724" style={{ stopColor: '#42a5f5', stopOpacity: '1' }} />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".039" style={{ stopColor: '#90caf9', stopOpacity: '1' }} />
        <stop offset=".919" style={{ stopColor: '#1565c0', stopOpacity: '1' }} />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".558" style={{ stopColor: '#1976d2', stopOpacity: '0' }} />
        <stop offset="1" style={{ stopColor: '#42a5f5', stopOpacity: '.501961' }} />
      </radialGradient>
    </defs>
    <path
