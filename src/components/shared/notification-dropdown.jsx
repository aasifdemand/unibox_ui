          ...
          >
            ...
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-md flex items-center justify-center text-slate-400 hover:bg-white hover:text-slate-800 hover:shadow-sm transition-all"
                >
            ...
            <div className="p-2 border-t border-slate-100 bg-slate-50/50">
              ...
              >
                ...
                <ChevronRight
                  className={`w-3.5 h-3.5 transition-transform group-hover:translate-x-1 ${i18n.dir() === 'rtl' ? 'rotate-180 group-hover:-translate-x-1' : ''}`}
                />
              </button>
            </div>
          </motion.div>
