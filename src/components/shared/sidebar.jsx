        ...
        <div className="flex items-center h-20 px-6 border-b border-slate-100 bg-white/50 backdrop-blur-xl sticky top-0 z-10">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-1 ltr:-right-1 rtl:-left-1 w-3 h-3 bg-indigo-400 rounded-full border-2 border-white animate-pulse"></div>
            </div>
            {!sidebarCollapsed && (
          ...
          {!sidebarCollapsed && (
            <div className="px-2">
              <div className="bg-linear-to-br from-blue-500 to-indigo-600 rounded-3xl p-5 shadow-2xl shadow-blue-500/20 relative overflow-hidden group">
                <div className="absolute top-0 ltr:right-0 rtl:left-0 w-32 h-32 bg-white/10 rounded-full -ltr:mr-16 rtl:ml-16 -mt-16 blur-2xl group-hover:scale-110 transition-transform duration-700"></div>
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-3">
                    <Sparkles className="w-4 h-4 text-blue-100" />
                    <span className="text-[10px] font-extrabold text-blue-50 uppercase tracking-widest">
                      {t('common.promo.title')}
                    </span>
                  </div>
                ...
                >
                  ...
                  >
                    <div className="relative flex items-center justify-center shrink-0">
                      <Icon
                        className={`w-5 h-5 transition-all duration-300 ${isActive ? 'scale-110' : 'group-hover:text-blue-500 group-hover:scale-110'
                          }`}
                      />
                    </div>
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute ltr:-right-4 rtl:-left-4 w-1 h-6 bg-blue-500 rounded-full shadow-[0_0_12px_rgba(59,130,246,0.5)]"
                      />
                    )}
                    {!sidebarCollapsed && (
                      <div className="ltr:ml-4 rtl:mr-4 flex-1 flex items-center justify-between overflow-hidden">
                        <span
                        ...
                        {item.badge && (
                          <span
                            className={`px-1.5 py-0.5 text-[9px] font-extrabold rounded-lg uppercase tracking-widest ${isActive ? 'bg-blue-500 text-white' : 'bg-blue-50 text-blue-600'
                              }`}
                          >
                            {item.badge}
                          </span>
                    ...
                    {sidebarCollapsed && activeHover === item.path && (
                      <div className="absolute left-full ltr:ml-4 ltr:mr-4 rtl:ml-4 px-3 py-2 bg-blue-600 text-white text-[10px] font-extrabold uppercase tracking-widest rounded-xl shadow-2xl z-50 animate-in fade-in slide-in-from-ltr:left-2 ltr:right-2 rtl:left-2 duration-200 pointer-events-none whitespace-nowrap">
                        {item.label}
                      </div>
                    )}
                  </Link>
        ...
        <div className="p-4 border-t border-slate-100 bg-white/80 backdrop-blur-xl">
          ...
          >
            <div className="relative shrink-0">
              ...
              <div className="absolute -bottom-1 -ltr:right-1 rtl:left-1 w-4 h-4 bg-white rounded-full flex items-center justify-center shadow-sm">
