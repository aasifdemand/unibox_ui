        ...
        {showImageModal && (
          <div className="absolute inset-0 z-50 flex items-center justify-center p-6 bg-slate-900/10  animate-in fade-in duration-200">
            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 w-full max-w-sm animate-in zoom-in-95 duration-300">
              ...
              {/* Tabs */}
              <div className="flex gap-2 mb-5 bg-slate-100 p-1 rounded-md">
                <button
                  type="button"
              ...
              {imageUploadTab === 'url' ? (
                ...
                <>
                  ...
                  <button
                    onClick={() => setShowImageModal(false)}
                    className="w-full py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-all"
                  >
                    Cancel
                  </button>
                </>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-md"
                  />
                </div>
                <div>
                  <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2 block">
