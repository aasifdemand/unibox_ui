      ...
      {!parsedData ? (
        <div
          className={`relative border-2 border-dashed rounded-2xl py-8 transition-all duration-300 flex flex-col items-center justify-center gap-3 ${
            dragActive ? 'border-orange-500 bg-orange-50/50 scale-[0.99]' : 'border-slate-200 bg-slate-50/30'
          }`}
        ...
        <div className="p-3 bg-orange-50/50 border-2 border-orange-100 rounded-2xl animate-in zoom-in duration-300">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] font-bold text-orange-600 uppercase tracking-widest mt-0.5">{parsedData.length} Accounts detected</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-5 py-2 bg-orange-600 text-white rounded-xl text-[9px] font-extrabold uppercase tracking-widest shadow-md shadow-orange-600/10 hover:-translate-y-0.5 transition-all active:scale-95 disabled:opacity-50 flex items-center gap-2"
              >
